  ...
  <div class="container-fluid">
    <div class="row mt-3">
      <div class="col-sm-3 ">
        ...
        <a href="follow.php?HN=<?php echo $row["HN"];?>" class="list-group-item list-group-item-action" >ข้อมูลทั่วไป</a>
...
require('Dm.php');
 ...
 $sql="SELECT *FROM m4 WHERE $HN=HN ORDER BY  id desc";
        ...
        <div class="row">
          ...
          <div class="col-md-12 ">
           ...
           <?php foreach ($result as $row) {?>          
              ...
              <input type="text" readonly style="border:none;"value="<?php echo $row['HN'];?>" name="HN"><br>
        <label> วันที่  :</label> 
               <input type="date" style="border:none;" readonly value="<?php echo $row['da'];?>"><br>
               <div class="radio">
               <?php
                echo $row['Problem'];
                ?>
