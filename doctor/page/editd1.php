    ...
    <img
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item " >
            <a class="nav-link"style="margin-left: 840px;" href="/login/doctor.php"   onclick="return confirm('คุณต้องการออกจากระบบหรือไม่')" >ออกจากระบบ</a>
          </li>
      ...
      <div class="col">
        <div class="row">
                  ...
                  <div>
                      ...
                      <div > 
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group"> 
                          <label for="">Adjusted Date of Birth</label>
                          <input type="date" name="adjust"  value="<?php echo $row["adjust"];?>" ><br>
                          </div><br>
                          ...
                          <?php 
                          if($row['born'] == "ในโรงพยาบาลมหาราชนครเชียงใหม่"){
                            echo "<input type='radio' name='born' value='ในโรงพยาบาลมหาราชนครเชียงใหม่' checked>ในโรงพยาบาลมหาราชนครเชียงใหม่";
                            echo "<input type='radio' name='born' value='นอกโรงพยาบาลมหาราชนครเชียงใหม่' >ในโรงพยาบาลมหาราชนครเชียงใหม่";
                          }else if($row['born'] == "นอกโรงพยาบาลมหาราชนครเชียงใหม่") {
                            echo "<input type='radio' name='born' value='ในโรงพยาบาลมหาราชนครเชียงใหม่' >ในโรงพยาบาลมหาราชนครเชียงใหม่";
                            echo "<input type='radio' name='born' value='นอกโรงพยาบาลมหาราชนครเชียงใหม่' checked>นอกโรงพยาบาลมหาราชนครเชียงใหม่";
                          }else{
                            echo "ไม่มีข้อมูล";
                          }
                         ?>
         ...
         <div class="form-group">
         <label>ระบุ</label>
         <input type="text" name="why"class="col-1"  value="<?php echo $row["why"];?>">
         </div>
