...
$sql = "SELECT * FROM  Nurse WHERE fname='$fname'  ";
...
<table class="table table-hover mt-4">
    ...
    <?php while($row=mysqli_fetch_assoc($result)){?>
      ...
      <td> <a href="Problem.php?HN=<?php echo $row["HN"];?>" class="btn btn-secondary"id="a" >ปัญหา</td>
      <td>
        <a href="delete.php?idp=<?php echo $row["HN"];?>"id="ฟ" class="btn btn-danger" 
